			...
			<div class="psp-grid-row psp-equal-column-container">
				...
				<div id="psp-archive-content" class="psp-col-md-10 psp-pull-right">
					...
					<div class="psp-grid-row">
						...
						<?php $active_projects = psp_get_all_my_projects('active'); ?>
						
						<?php $my_projects = psp_get_all_my_projects();	?>
							
						<?php $project_overview = psp_my_projects_overview($my_projects); ?>
					...
					<div class="psp-archive-section">
						...
						<div class="psp-archive-list-wrapper">
							<?php echo psp_archive_project_listing($active_projects); ?>
						</div>
				...
				<div id="psp-archive-menu" class="psp-col-md-2 psp-pull-left">
					...
					<div class="psp-archive-projects">
						...
						<?php $active_projects = psp_get_active_projects($my_projects); ?>
						
						<?php if(!empty($active_projects)): ?>
							<ul class="psp-project-list">
								<?php foreach($active_projects as $project): ?>
									<li><a href="<?php echo $project['permalink']; ?>"><?php echo $project['title']; ?></a></li>
								<?php endforeach; ?>
							</ul>
						<?php else: ?>
